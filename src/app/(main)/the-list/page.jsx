  ...
  return (
    <>
      <Container className="pt-16 pb-12 sm:pb-4 lg:pt-12">
        <div className="grid">
          <div>
            ...
            <p>
              Each week, the Elves rank, review, and discuss Christmas movies.
              These rankings have lead to our Naughty and Nice List. Here&apos;s
              our ranked list, in order, with the combined ranking of all three
              elves.
            </p>
          </div>
        </div>
      ...
      <div>
        ...
        <Movie href="/im-following-in-the-path-of-my-christmas-heroes-the-grinch-the-sticky-bandits-hans-gruber-from-die-hard" index={68} title="The Night Before" rank="4.65" src="agyemwQD9x?ixlib=js-3.7.0&s=5c1b16e2176ea54921bddba27eac9145" />
